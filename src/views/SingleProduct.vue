                            ...
                            <div class="lg:order-2 lg:ml-5">
                                <div class="max-w-xl overflow-hidden rounded-lg">
                                    <img class="h-full w-full max-w-full object-cover"
                                        src="https://dynamic.zacdn.com/eedj0Dm9Q6sTDucWkfjyw6CsiR4=/filters:quality(70):format(webp)/https://static-id.zacdn.com/p/jenahara-9719-1093614-3.jpg"
                                        alt="" />
                                </div>
                            </div>
                            ...
                            <div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
                                <div class="flex flex-row items-start lg:flex-col">
                                    ...
                                    <button type="button"
                                        class="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-transparent text-center">
                                        <img class="h-full w-full object-cover"
                                            src="https://dynamic.zacdn.com/JzIt6bNmXkWTTboDExuIOu3ZhGg=/filters:quality(70):format(webp)/https://static-id.zacdn.com/p/jenahara-9719-1093614-2.jpg  "
                                            alt="" />
                                    </button>
                                </div>
                            </div>
